...
import sys
import vlc
from TedCommon import VIDEO_WIDTH, VIDEO_HEIGHT
...
class VideoWgt(QWidget):
    """ video widget class """
    videoFrameComplete = pyqtSignal()
    ...
    def play(self, init_time=None, end_time=None, offset=0):
        """ play video """
        if not self.media_player.is_playing():
            if end_time is not None:
                self.__end_time = end_time + offset
                self.timer.start()
            ...
            if init_time is not None:
                ...
                if init_time == 0:
                    ...
                    self.media_player.set_time(init_time + offset)
...
class MainWindow(QMainWindow):
    ...
    def createUi(self):
        ...
        self.main_layout.addWidget(self.video_wgt)
